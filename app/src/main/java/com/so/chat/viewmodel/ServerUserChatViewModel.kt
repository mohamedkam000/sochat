...
class ServerUserChatViewModel(private val socketManager: ServerSocketManager, private val repository: MessageRepository,
                              private val userManager: UserIdentityManager
): ViewModel() {
